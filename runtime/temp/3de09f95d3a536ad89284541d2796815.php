<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"F:\www\twothink\public/../application/admin/view/default/repair\index.html";i:1533790808;s:73:"F:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!(empty($repairs) || (($repairs instanceof \think\Collection || $repairs instanceof \think\Paginator ) && $repairs->isEmpty()))): if(is_array($repairs) || $repairs instanceof \think\Collection || $repairs instanceof \think\Paginator): $i = 0; $__LIST__ = $repairs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$repair): $mod = ($i % 2 );++$i;?>
					<tr>
						<td><input class="ids row-selected" type="checkbox" name="id[]" id="" value="<?php echo $repair['id']; ?>"> </td>
						<td><?php echo $repair['id']; ?></td>
						<td><a title="编辑" href="<?php echo url('edit?id='.$repair['id']); ?>"><?php echo $repair['title']; ?></a></td>
						...
						<td>
							<a title="编辑" href="<?php echo url('edit?id='.$repair['id']); ?>">编辑</a>
