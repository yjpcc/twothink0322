<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"F:\www\twothink\public/../application/home/view/default/repair\repair.html";i:1533793026;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url('Repair/add'); ?>" method="post">
            ...
            <!--</div>-->
            <div class="form-group">
                <button class="btn btn-primary ajax-posts btn-block" type="submit">确认提交</button>
            </div>
        </form>
    </div>
</div>
