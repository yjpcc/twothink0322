<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"F:\www\twothink\public/../application/admin/view/default/repair\edit.html";i:1533717812;s:73:"F:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<label class="textarea">
			<textarea name="des"><?php echo (isset($info['des']) && ($info['des'] !== '')?$info['des']:''); ?></textarea>
			<!--<?php echo hook('adminArticleEdit', array('name'=>'des','value'=>$field['value'])); ?>-->
		</label>
		</div>
		<div class="form-item">
