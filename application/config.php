...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'l[BCb^KwR~F.4DZQ9"V/mT?!$hc}|np(I,d6S1`E', //默认数据加密KEY
	'data_cache_key'=> 'l[BCb^KwR~F.4DZQ9"V/mT?!$hc}|np(I,d6S1`E',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'l[BCb^KwR~F.4DZQ9"V/mT?!$hc}|np(I,d6S1`E', //加密KEY
